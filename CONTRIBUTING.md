...
1. Open an issue for each acceptance gap or behavior change.
...
5. Update `docs/DESIGN.md` when weights, evidence order, or signing logic changes.

## Commit Style

Use short imperative messages, for example:

- `Add release evidence scoring`
- `Document mooncakes publish checklist`
- `Cover duplicate evidence in tests`
